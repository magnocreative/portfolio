      ...
      <main>
        ...
        <Container>
          <section className="pt-24 pb-4 md:pt-36">
            ...
            <h1 className="text-optical mt-10 max-w-[15ch] font-display text-4xl leading-[1.04] tracking-[-0.025em] text-text-primary text-pretty md:text-5xl xl:max-w-[21ch] lg:text-6xl">
